...
local Tabs = {
    fastAttackAdmin = Window:AddTab({ Title = "fastAttackAdmin", Icon = "wifi" }),
...
-- Hehe
--------------------------------------------------------------------------------------------------------------------------------------------
local fastAttackAdmin = Tabs.fastAttackAdmin:AddSection("fastAttackAdmin")
    local ToggleFastAttack = Tabs.fastAttackAdmin:AddToggle("ToggleFastAttack", {Title = "Fast Attack", Default = true })
...
warn("NoName Hub Loading Completed !!")
